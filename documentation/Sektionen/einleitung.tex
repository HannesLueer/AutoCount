...
Im vergangenen Wintersemester (2022/23) gab es 4890 immatrikulierte Studenten und 518 Mitarbeiter \cite{HSCobugZahlen}.

\begin{figure}[h]
	\myImagePos{}
	\includegraphics[width=0.6\myImageWidth]{Bilder/parkhaus_HSCoburg.jpg}
	\caption[Parkhaus der Hochschule Coburg]{Parkhaus der Hochschule Coburg (Campus Friedrich Streib) \cite{parkhaus}}
	\label{fig:Parkhaus}
\end{figure}
