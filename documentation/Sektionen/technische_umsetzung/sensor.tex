...
\textcolor{red}{
	\begin{itemize}
		\item Grundidee:
		      \begin{itemize}
			      \item Einteilen des Videos in zwei Bereiche (horizontal - z. B. Einfahrt des Parkhaus)
			      \item bei Änderung des Bereichs -> hoch- oder runterzählen
		      \end{itemize}
		\item Vorgehen:
		      \begin{itemize}
			      \item Mittelpunkt der Objekterkennung
			      \item jedes Auto mit ID versehen
			      \item schauen in welchem Bereich sich ID befindet
			      \item Bei Änderung des Bereichs hoch bzw. runterzählen --> API Aufruf
		      \end{itemize}
	\end{itemize}
}
